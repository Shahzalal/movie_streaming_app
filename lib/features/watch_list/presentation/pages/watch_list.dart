...
class WatchList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double itemHeight = baseHeight / baseWidth * itemWidth;

    // Approx text height
    final double textHeight = SizeConfig.hs(50);
              ...
              itemBuilder: (context, index) {
                ...
                return Column(
                  ...
                  children: [
                    Expanded(
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(SizeConfig.ws(4)),
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                    ...
                    Row(
                      ...
                      children: [
                        Icon(Icons.star,
                            color: Colors.amber, size: SizeConfig.ws(14)),
                        SizedBox(width: SizeConfig.ws(4)),
                        UiHelper.customText(
                          text: "${movie["rating"]}",
                          fontsize: SizeConfig.ws(12),
